...
public class raspunsGresit extends Actor
{
     ...
     */
    public raspunsGresit(int value, int fontSize)
    {
     ...
     */
    public raspunsGresit(String value, int fontSize)
    {
        this.value = value;
    ...
    public void act()
    {
     if(Greenfoot.mouseClicked(this))
     {
      ...
      if(buton1==this) buton1 = getWorld().getObjects(raspunsGresit.class).get(1);
      Actor buton2 = getWorld().getObjects(raspunsCorect.class).get(0);
